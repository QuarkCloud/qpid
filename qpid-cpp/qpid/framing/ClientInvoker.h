...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::Invoker:
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::ConnectionHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::SessionHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::ExecutionHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::MessageHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::FileHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_ClientOperations::StreamHandler::Invoker:
    public qpid::framing::Invoker
{
